        ...
        <div className="home-container">
            ...
            <section className="hero-section">
                <div className="hero-image">
                    <img src={CarroGris} alt="Coche de lujo" />
                </div>
            ...
            <section className="promo-section">
                ...
                <div className="promo-content">
                    ...
                    <p>El coche más innovador con prestaciones de primer nivel y características de alto rendimiento.</p>
                </div>
            </section>
            ...
            <section className="featured-vehicles">
                ...
                <div className="vehicle-list">
                    <div className="vehicle-item">
                        <img src={QashqaiImg} alt="Qashqai" />
                        <h4>QASHQAI</h4>
                    ...
                    <div className="vehicle-item">
                        <img src={CivicTypeRImg} alt="Civic Type R 2024" />
