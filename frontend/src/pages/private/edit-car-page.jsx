...
export default function EditCarPage({ car, onBack }) {
  ...
  // Initialize form with car data when component mounts or car changes
  useEffect(() => {
    if (car) {
      setCarData({
        model: car.name || "",
        ...
        compatibleKits: car.compatibleKits || "",
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center space-x-4">
        ...
        <h2 className="text-xl font-medium">Editar Vehículo: {car?.name}</h2>
      </div>
